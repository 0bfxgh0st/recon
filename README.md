...
Options:
      ...
      --dns           subdomain fuzzing   (wordlist required)
...
recon 10.0.2.15 --dns /usr/share/seclists/Discovery/DNS/namelist.txt
```
Ouput Auto recon  
```
┌──(root💀ghost)-[/home/ghost]
...
```
┌──(root💀ghost)-[/home/ghost]
└─# recon 10.0.2.41 --axfr ghostlab.sv
...
[DiG]
; <<>> DiG 9.18.1-1-Debian <<>> @10.0.2.41 ghostlab.sv axfr
; (1 server found)
;; global options: +cmd
ghostlab.sv.          3600    IN      SOA     websrv01.ghostlab.sv. root.ghostlab.sv. 1594567384 3600 600 1209600 3600
ghostlab.sv.          3600    IN      NS      ns1.ghostlab.sv.
ns1.ghostlab.sv.      3600    IN      A       127.0.0.1
recoveryplan.ghostlab.sv. 3600 IN     A       127.0.0.1
websrv01.ghostlab.sv. 3600    IN      A       127.0.0.1
ghostlab.sv.          3600    IN      SOA     websrv01.ghostlab.sv. root.ghostlab.sv. 1594567384 3600 600 1209600 3600
;; Query time: 0 msec
;; SERVER: 10.0.2.41#53(10.0.2.41) (TCP)
;; WHEN: Mon Oct 24 12:21:36 EDT 2022
